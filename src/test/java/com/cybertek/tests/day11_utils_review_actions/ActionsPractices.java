...
public class ActionsPractices {
    ...
    public void hover_over_test(){
        ...
        //#3- Do the assertion
        Assert.assertTrue(user1.isDisplayed(), "User1 is NOT displayed, Verification Failed!!!");

        // Moving to img2
        BrowserUtils.wait(2);
        actions.moveToElement(img2).perform();
        Assert.assertTrue(user2.isDisplayed(), "User2 is not displayed! Verification Failed!!!");

        // Moving to img3
        BrowserUtils.wait(2);
        actions.moveToElement(img3).perform();
        Assert.assertTrue(user3.isDisplayed(), "User3 is not displayed! Verification Failed!!!");
